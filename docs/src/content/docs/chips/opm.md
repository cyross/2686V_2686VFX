...
| **D1R** | 1 段目の減衰の速さ（他機種の DR） | [`OPM_OP[0-3]_R_D2R`](/2686V_2686VFX/reference/automation/opm/#opm-op-0-3-r-d2r) |
...
| **Bypass** | 音量エンベロープを通さない（**独自**） | [`OPM_OP[0-3]_AMP_BYPASS`](/2686V_2686VFX/reference/automation/opm/#opm-op-0-3-amp-bypass) |
...
| つまみ | 内容 | オートメーション |
| --- | --- | --- |
| **LFRQ** | 揺れの速さ | [`OPM_LFO_FREQ`](/2686V_2686VFX/reference/automation/opm/#opm-lfo-freq) |
| **SYNC DELAY** | 押してから揺れ始めるまでの待ち | [`OPM_LFO_SYNC_DELAY`](/2686V_2686VFX/reference/automation/opm/#opm-lfo-sync-delay) |
| **PM** | 音程側の揺れを掛ける | [`OPM_LFO_PM`](/2686V_2686VFX/reference/automation/opm/#opm-lfo-pm) |
| **PG SHAPE** | 音程側の形。実機と同じ 4 種 | [`OPM_LFO_PG_SHAPE`](/2686V_2686VFX/reference/automation/opm/#opm-lfo-pg-shape) |
...
| **AM** | 音量側の揺れを掛ける | [`OPM_LFO_AM`](/2686V_2686VFX/reference/automation/opm/#opm-lfo-am) |
| **EG SHAPE** | 音量側の形 | [`OPM_LFO_EG_SHAPE`](/2686V_2686VFX/reference/automation/opm/#opm-lfo-eg-shape) |
...
| **AM SMOOTH** | 音量側の角の丸め（**独自**） | [`OPM_LFO_ASMRT`](/2686V_2686VFX/reference/automation/opm/#opm-lfo-asmrt) |
...
| つまみ | 内容 | オートメーション |
| --- | --- | --- |
| **KS MODE** | 実機のやり方（OPM）か、OPP のやり方かを選ぶ（**独自**） | [`OPM_OP[0-3]_KS_MODE`](/2686V_2686VFX/reference/automation/opm/#opm-op-0-3-ks-mode) |
| **KS** | 実機のキースケール | [`OPM_OP[0-3]_KS`](/2686V_2686VFX/reference/automation/opm/#opm-op-0-3-ks) |
| **KSR（OPP）** | OPP 側。音が高いほどエンベロープを速める | [`OPM_OP[0-3]_KSR_OPP`](/2686V_2686VFX/reference/automation/opm/#opm-op-0-3-ksr-opp) |
| **KSL（OPP）** | OPP 側。音が高いほど音量を下げる | [`OPM_OP[0-3]_KSL_OPP`](/2686V_2686VFX/reference/automation/opm/#opm-op-0-3-ksl-opp) |
...
| つまみ | 内容 | オートメーション |
| --- | --- | --- |
| **KOR** | 鍵を離しても減衰させない（**独自**） | [`OPM_OP[0-3]_KOR`](/2686V_2686VFX/reference/automation/opm/#opm-op-0-3-kor) |
