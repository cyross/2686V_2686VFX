---
title: OPL channel
description: What is inside .param.opl.json
sidebar:
  order: 32
---
...
| | |
| --- | --- |
| **Extension** | `.param.opl.json` / `.param.opl.yaml` |
| **format** | `opl` |
| **version** | `1` |
| **Export / import** | UTILITY's [EX] / [IM] |
| **The chip's page** | [opl](/2686V_2686VFX/en/chips/opl/) |
...
| --- | --- | --- | ---: |
| `alg` | integer | 1 – 2 (choice number + 1) | 1 |
...
Two operators are listed. Each one carries the following.
...
| `eg` | integer | 1 – 4 (choice number + 1) | 1 |
