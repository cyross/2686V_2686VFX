...
description: What is inside .pitchEnv.json
sidebar:
  order: 2
---

The PITCH ENV settings.

| | |
| --- | --- |
| **Extension** | `.pitchEnv.json` / `.pitchEnv.yaml` |
| **format** | `pitchEnv` |
| **version** | `1` |
| **Export / import** | PITCH ENV's [EX] / [IM] |
...
`pitchEnv` sits under `values`, and the keys are inside it.
