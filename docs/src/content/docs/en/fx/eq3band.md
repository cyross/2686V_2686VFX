...
| --- | --- | --- | ---: | --- |
| **LOW.GAIN** | How much low end (dB) | -15 – 15 | 0 | [`FX_EQ3B_LGDB`](/2686V_2686VFX/en/reference/automation/fx-plugin/#fx-eq3b-lgdb) |
| **MID.FREQ** | Which frequency counts as the middle (Hz) | 500 – 3000 | 2000 | [`FX_EQ3B_MFREQ`](/2686V_2686VFX/en/reference/automation/fx-plugin/#fx-eq3b-mfreq) |
| **MID.GAIN** | How much middle (dB) | -15 – 15 | 0 | [`FX_EQ3B_MGDB`](/2686V_2686VFX/en/reference/automation/fx-plugin/#fx-eq3b-mgdb) |
| **HI.GAIN** | How much high end (dB) | -15 – 15 | 0 | [`FX_EQ3B_HGDB`](/2686V_2686VFX/en/reference/automation/fx-plugin/#fx-eq3b-hgdb) |
...
Moving **MID.FREQ** changes what the same amount of gain lands on. Lift the band a voice sits in, bring out the body of a drum, and so on.
