...
**2686VFX** は、このシリーズで唯一のエフェクトです。音源に付いている FX タブを取り出して単体で使えるようにしたものです。
さらに、MIDI入力を併用すると、音源側にしかなかったエンベロープやLFO を、**出力そのものへ掛けられる**ようにしてあります。
...
<figure class="shot">
	<img src="/2686V_2686VFX/ui/plugin/2686VFX.png" alt="2686VFX プラグイン全景" width="1625" height="738" />
...
効果は仲間どうしを 1 列へ縦に積んで、4 列にまとめてあります。

| 列 | 効果 |
| --- | --- |
| 1 | フィルター / 3バンドイコライザー |
| 2 | トレモロ / ビブラート |
| 3 | ビットクラッシャー / PCMビットクラッシャー |
| 4 | ディレイ / リバーブ / SFCエコー |

この並びは種類でそろえたもので、**かける順番とは関係ありません。** 順番は
エフェクターの一覧で決めます。
