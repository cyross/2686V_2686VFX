...
namespace PresetValue
{
	...
	namespace File
	{
		...
		static inline const juce::String glob = "*.2686vl.json;*.2686vl.yaml;*.xml";

		// 書き出すときの拡張子。選ばれている形に合わせる。
		static inline juce::String extension()
		{
			return ".2686vl." + Io::fileFormatExtension();
		}
		...
		namespace Name
		{
			...
			static inline const juce::String library = "2686VLight.library";
		}
