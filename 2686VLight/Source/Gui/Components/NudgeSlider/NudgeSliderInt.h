...
public:
    ...
    GuiComponentNudgeSliderInt(const GuiContext& context) :
        GuiBase(context),
        mainSlider(context),
    ...
    int getValue() {
        return (int)mainSlider.getValue();
    };
    ...
    int getMinimum() { return (int)mainSlider.getMinimum(); }
    int getMaximum() { return (int)mainSlider.getMaximum(); }
    ...
    void setValue(int value, juce::NotificationType notification) {
