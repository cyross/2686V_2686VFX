...
namespace Io
{
	...
	namespace ExtensionGlob
	{
		...
		static inline const juce::String oplParam = "*.param.opl.json;*.param.opl.yaml;*.param.opl";
		static inline const juce::String opl3Param = "*.param.opl3.json;*.param.opl3.yaml;*.param.opl3";
		static inline const juce::String opmParam = "*.param.opm.json;*.param.opm.yaml;*.param.opm";
		...
		static inline const juce::String wtParam = "*.param.wt.json;*.param.wt.yaml;*.param.wt";
		static inline const juce::String wt2Param = "*.param.wt2.json;*.param.wt2.yaml;*.param.wt2";
		...
		static inline const juce::String oplOpParam = "*.param.opl.op.json;*.param.opl.op.yaml;*.param.opl.op";
		static inline const juce::String opl3OpParam = "*.param.opl3.op.json;*.param.opl3.op.yaml;*.param.opl3.op";
		static inline const juce::String opmOpParam = "*.param.opm.op.json;*.param.opm.op.yaml;*.param.opm.op";
		...
		static inline const juce::String OpmLfoParam = "*.lfoOpm.json;*.lfoOpm.yaml;*.lfoOpm";
		static inline const juce::String OplLfoParam = "*.lfoOpl.json;*.lfoOpl.yaml;*.lfoOpl";
