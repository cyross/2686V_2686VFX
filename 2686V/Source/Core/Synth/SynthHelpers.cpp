...
double SynthHelpers::getTargetRate(int index, double defaultValue) {
    switch (index) {
        case 1:
            return 96000.0;
        case 2:
...
float SynthHelpers::getTargetBitDepth(int index)
{
...
float SynthHelpers::getTargetMaxVal(int index)
{
