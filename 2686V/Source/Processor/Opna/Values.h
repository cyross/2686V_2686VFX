...
namespace OpnaPrValue
{
	...
	namespace Op
	{
		namespace RgAdsr
		{
			...
			namespace Dr
			{
				inline constexpr int min = CorePrValue::FmRg::Dr::min;
				inline constexpr int max = CorePrValue::FmRg::Dr::max;
				inline constexpr int initial = CorePrValue::FmRg::Dr::initial;
			}

			namespace Sl
			{
				inline constexpr int min = CorePrValue::FmRg::Sl::min;
				inline constexpr int max = CorePrValue::FmRg::Sl::max;
				inline constexpr int initial = CorePrValue::FmRg::Sl::initial;
			}

			namespace Sr
			{
				inline constexpr int min = CorePrValue::FmRg::Sr::min;
				inline constexpr int max = CorePrValue::FmRg::Sr::max;
				inline constexpr int initial = CorePrValue::FmRg::Sr::initial;
			}
