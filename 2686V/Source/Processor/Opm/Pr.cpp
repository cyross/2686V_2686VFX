...
void OpmProcessor::processBlock(SynthParams& params, juce::AudioProcessorValueTreeState& apvts)
{
    ...
    for (int op = 0; op < PrValue::Opm::ops; ++op)
    {
        ...
        params.opm.op[op].ampEnv.ar = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::ar);
        params.opm.op[op].ampEnv.d1r = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::d1r);
        params.opm.op[op].ampEnv.d1l = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::d1l);
        params.opm.op[op].ampEnv.d2r = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::d2r);
        params.opm.op[op].ampEnv.rr = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rr);
        params.opm.op[op].ampEnv.tl = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::tl);
        ...
        params.opm.op[op].fixMode.enable = (*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::fix) > PrValue::boolThread);
        params.opm.op[op].fixMode.freq = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::fixFreq);

        params.opm.op[op].waveSelect = 0; // Sine
        params.opm.op[op].egType = true;
        params.opm.op[op].vibEnable = false;
        params.opm.op[op].pms = 0;
        params.opm.op[op].amEnable = false;
        ...
        params.opm.op[op].regEnv.enable = (*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rgEn) > PrValue::boolThread);
        params.opm.op[op].regEnv.ar = (int)*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rgAr);
        params.opm.op[op].regEnv.d1r = (int)*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rgD1r);
        params.opm.op[op].regEnv.d1l = (int)*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rgD1l);
        params.opm.op[op].regEnv.d2r = (int)*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rgD2r);
        params.opm.op[op].regEnv.rr = (int)*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rgRr);
        params.opm.op[op].regEnv.tl = (int)*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rgTl);
    }
}
