...
void Opzx7Processor::createLayout(juce::AudioProcessorValueTreeState::ParameterLayout& layout)
{
    ...
    for (int op = 0; op < Opzx7PrValue::ops; ++op)
    {
        ...
        layout.add(std::make_unique<juce::AudioParameterBool>(opPrefix + Opzx7PrKey::ksr, opPrefixName + Opzx7PrName::ksr, Opzx7PrValue::Op::Ksr::initial));
        layout.add(std::make_unique<juce::AudioParameterInt>(opPrefix + Opzx7PrKey::ksl, opPrefixName + Opzx7PrName::ksl, Opzx7PrValue::Op::Ksl::min, Opzx7PrValue::Op::Ksl::max, Opzx7PrValue::Op::Ksl::initial));
