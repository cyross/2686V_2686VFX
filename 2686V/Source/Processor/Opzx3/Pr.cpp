...
void Opzx3Processor::processBlock(SynthParams& params, juce::AudioProcessorValueTreeState& apvts)
{
    ...
    params.opzx3.feedback0 = *apvts.getRawParameterValue(code + PrKey::Post::Fm::fb0);
    params.opzx3.feedback2 = *apvts.getRawParameterValue(code + PrKey::Post::Fm::fb2);
    params.opzx3.bitDepth = (int)*apvts.getRawParameterValue(code + PrKey::Post::Fm::bit);
    params.opzx3.rateIndex = (int)*apvts.getRawParameterValue(code + PrKey::Post::Fm::rate);
    ...
    for (int op = 0; op < PrValue::Opzx3::ops; ++op)
    {
        ...
        params.opzx3.op[op].ampEnv.ar = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::ar);
        params.opzx3.op[op].ampEnv.d1r = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::d1r);
        params.opzx3.op[op].ampEnv.d1l = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::d1l);
        params.opzx3.op[op].ampEnv.d2r = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::d2r);
        params.opzx3.op[op].ampEnv.rr = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rr);
        params.opzx3.op[op].ampEnv.tl = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::tl);
        ...
        params.opzx3.op[op].fixMode.enable = (*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::fix) > PrValue::boolThread);
        params.opzx3.op[op].fixMode.freq = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::fixFreq);
        ...
        params.opzx3.op[op].regEnv.enable = (*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rgEn) > PrValue::boolThread);
        params.opzx3.op[op].regEnv.ar = (int)*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rgAr);
        params.opzx3.op[op].regEnv.d1r = (int)*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rgD1r);
        params.opzx3.op[op].regEnv.d1l = (int)*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rgD1l);
        params.opzx3.op[op].regEnv.d2r = (int)*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rgD2r);
        params.opzx3.op[op].regEnv.rr = (int)*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rgRr);
        params.opzx3.op[op].regEnv.tl = (int)*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rgTl);
    }
}
