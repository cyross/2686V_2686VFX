...
void Opl3Processor::processBlock(SynthParams& params, juce::AudioProcessorValueTreeState& apvts)
{
    ...
    params.opl3.algorithm = (int)*apvts.getRawParameterValue(code + PrKey::Post::Fm::alg);
    params.opl3.feedback = *apvts.getRawParameterValue(code + PrKey::Post::Fm::fb0);
    params.opl3.feedback2 = *apvts.getRawParameterValue(code + PrKey::Post::Fm::fb2);
    params.opl3.fmBitDepth = (int)*apvts.getRawParameterValue(code + PrKey::Post::Fm::bit);
    params.opl3.fmRateIndex = (int)*apvts.getRawParameterValue(code + PrKey::Post::Fm::rate);
    ...
    for (int op = 0; op < PrValue::Opl3::ops; ++op)
    {
        ...
        params.opl3.op[op].multiple = (int)*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::mul);
        params.opl3.op[op].detune = 0;
        params.opl3.op[op].ampEnv.ar = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::ar);
        params.opl3.op[op].ampEnv.dr = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::dr);
        params.opl3.op[op].ampEnv.sl = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::sl);
        params.opl3.op[op].ampEnv.rr = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rr);
        params.opl3.op[op].ampEnv.tl = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::tl);
        bool ksrOn = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::ksr) > PrValue::boolThread;
        params.opl3.op[op].keyScale = ksrOn ? 3 : 0;
        params.opl3.op[op].keyScaleLevel = (int)*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::ksl);
        ...
        params.opl3.op[op].waveSelect = (int)*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::eg);
        params.opl3.op[op].egType = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::egType) > PrValue::boolThread;
        params.opl3.op[op].vibEnable = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::vib) > PrValue::boolThread;
        params.opl3.op[op].pms = 0;
        params.opl3.op[op].amEnable = (*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::am) > PrValue::boolThread);
        params.opl3.op[op].ams = 0;
        params.opl3.op[op].oplAms = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::ams);
        params.opl3.op[op].oplAmd = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::amd);
        params.opl3.op[op].oplPms = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::pms);
        params.opl3.op[op].oplPmd = *apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::pmd);
        params.opl3.op[op].mask = (*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::mask) > PrValue::boolThread);

        params.opl3.op[op].regEnv.enable = (*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rgEn) > PrValue::boolThread);
        params.opl3.op[op].regEnv.ar = (int)*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rgAr);
        params.opl3.op[op].regEnv.dr = (int)*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rgDr);
        params.opl3.op[op].regEnv.sl = (int)*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rgSl);
        params.opl3.op[op].regEnv.rr = (int)*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rgRr);
        params.opl3.op[op].regEnv.tl = (int)*apvts.getRawParameterValue(p + PrKey::Post::Fm::Op::rgTl);
    }
}
