...
{
    PrHelper::applyAdpcmBasic(pBasic, params.adpcmPlus);
    ...
    PrHelper::applyToneNoise(pToneNoise, params.adpcmPlus.tn);
    PrHelper::applyPcm(pPcm, params.adpcmPlus.pcm);
    PrHelper::applyLp(pLp, params.adpcmPlus.lp);
