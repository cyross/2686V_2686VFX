...
namespace SsgGuiText
{
	...
	namespace Category
	{
		...
		static inline const juce::String ssgEnv = u8"--- SSG ENVELOPE ---";
		...
		static inline const juce::String invisibilePan = u8"[▼]--- PAN ---";
	...
	namespace Fm
	{
		...
		static inline const juce::String lfoPmShape = u8"P.Shape";
		static inline const juce::String lfoAmShape = u8"A.Shape";
