...
void GuiComponentPitchButtons::setupComponent(juce::Component& parent, GuiSlider& slider, int& tabOrder)
{
    minus1200.setup({ .parent = parent, .id = "", .title = "-1200", .isReset = false });
    ...
    minus100.setup({ .parent = parent, .id = "", .title = "-100", .isReset = false });
    ...
    pm0.setup({ .parent = parent, .id = "", .title = "0", .isReset = false });
    ...
    plus100.setup({ .parent = parent, .id = "", .title = "+100", .isReset = false });
    ...
    plus1200.setup({ .parent = parent, .id = "", .title = "+120", .isReset = false });
...
void GuiComponentPitchButtons::layoutComponent(juce::Rectangle<int>& rect)
{
    layoutMainFiveComps({
        .rect = rect,
        .comp1 = &minus1200,
...
void GuiComponentPitchButtons::layoutComponentRow(juce::Rectangle<int>& rect)
{
    layoutRowFiveComps({
        .rect = rect,
        .comp1 = &minus1200,
