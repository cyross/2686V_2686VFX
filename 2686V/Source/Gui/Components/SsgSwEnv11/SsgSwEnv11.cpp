...
void GuiComponentSsgSwEnv11::setupComponent(juce::Component& parent, const juce::String& code, int &tabOrder, const juce::String& flagKey, const juce::String& flagText, bool isEnable)
{
    ...
    r1.setupComponent(parent, code + CPK::SsgSwEnv11::r1, "R1", tabOrder, std::nullopt, labelFont);

    r1Nudge.setupComponent(parent, r1.getSlider(), tabOrder);

    r2.setupComponent(parent, code + CPK::SsgSwEnv11::r2, "R2", tabOrder, std::nullopt, labelFont);

    r2Nudge.setupComponent(parent, r2.getSlider(), tabOrder);

    r3.setupComponent(parent, code + CPK::SsgSwEnv11::r3, "R3", tabOrder, std::nullopt, labelFont);

    r3Nudge.setupComponent(parent, r3.getSlider(), tabOrder);

    r4.setupComponent(parent, code + CPK::SsgSwEnv11::r4, "R4", tabOrder, std::nullopt, labelFont);

    r4Nudge.setupComponent(parent, r4.getSlider(), tabOrder);

    r5.setupComponent(parent, code + CPK::SsgSwEnv11::r5, "R5", tabOrder, std::nullopt, labelFont);

    r5Nudge.setupComponent(parent, r5.getSlider(), tabOrder);

    r6.setupComponent(parent, code + CPK::SsgSwEnv11::r6, "R6", tabOrder, std::nullopt, labelFont);

    r6Nudge.setupComponent(parent, r6.getSlider(), tabOrder);

    r7.setupComponent(parent, code + CPK::SsgSwEnv11::r7, "R7", tabOrder, std::nullopt, labelFont);

    r7Nudge.setupComponent(parent, r7.getSlider(), tabOrder);

    r8.setupComponent(parent, code + CPK::SsgSwEnv11::r8, "R8", tabOrder, std::nullopt, labelFont);

    r8Nudge.setupComponent(parent, r8.getSlider(), tabOrder);

    r9.setupComponent(parent, code + CPK::SsgSwEnv11::r9, "R9", tabOrder, std::nullopt, labelFont);

    r9Nudge.setupComponent(parent, r9.getSlider(), tabOrder);

    r10.setupComponent(parent, code + CPK::SsgSwEnv11::r10, "R10", tabOrder, std::nullopt, labelFont);

    r10Nudge.setupComponent(parent, r10.getSlider(), tabOrder);

    r11.setupComponent(parent, code + CPK::SsgSwEnv11::r11, "R11", tabOrder, std::nullopt, labelFont);

    r11Nudge.setupComponent(parent, r11.getSlider(), tabOrder);

    rateSeparator.setupComponent(parent);

    startLevel.setupComponent(parent, code + CPK::SsgSwEnv11::stl, "STL", tabOrder, std::nullopt, labelFont);

    stlBtns.setupComponent(parent, startLevel.getSlider(), tabOrder, labelFont);

    l1.setupComponent(parent, code + CPK::SsgSwEnv11::l1, "L1", tabOrder, std::nullopt, labelFont);

    l1Btns.setupComponent(parent, l1.getSlider(), tabOrder, labelFont);

    l2.setupComponent(parent, code + CPK::SsgSwEnv11::l2, "L2", tabOrder, std::nullopt, labelFont);

    l2Btns.setupComponent(parent, l2.getSlider(), tabOrder, labelFont);

    l3.setupComponent(parent, code + CPK::SsgSwEnv11::l3, "L3", tabOrder, std::nullopt, labelFont);

    l3Btns.setupComponent(parent, l3.getSlider(), tabOrder, labelFont);

    l4.setupComponent(parent, code + CPK::SsgSwEnv11::l4, "L4", tabOrder, std::nullopt, labelFont);

    l4Btns.setupComponent(parent, l4.getSlider(), tabOrder, labelFont);

    l5.setupComponent(parent, code + CPK::SsgSwEnv11::l5, "L5", tabOrder, std::nullopt, labelFont);

    l5Btns.setupComponent(parent, l5.getSlider(), tabOrder, labelFont);

    l6.setupComponent(parent, code + CPK::SsgSwEnv11::l6, "L6", tabOrder, std::nullopt, labelFont);

    l6Btns.setupComponent(parent, l6.getSlider(), tabOrder, labelFont);

    l7.setupComponent(parent, code + CPK::SsgSwEnv11::l7, "L7", tabOrder, std::nullopt, labelFont);

    l7Btns.setupComponent(parent, l7.getSlider(), tabOrder, labelFont);

    l8.setupComponent(parent, code + CPK::SsgSwEnv11::l8, "L8", tabOrder, std::nullopt, labelFont);

    l8Btns.setupComponent(parent, l8.getSlider(), tabOrder, labelFont);

    l9.setupComponent(parent, code + CPK::SsgSwEnv11::l9, "L9", tabOrder, std::nullopt, labelFont);

    l9Btns.setupComponent(parent, l9.getSlider(), tabOrder, labelFont);

    l10.setupComponent(parent, code + CPK::SsgSwEnv11::l10, "L10", tabOrder, std::nullopt, labelFont);

    l10Btns.setupComponent(parent, l10.getSlider(), tabOrder, labelFont);

    l11.setupComponent(parent, code + CPK::SsgSwEnv11::l11, "L11", tabOrder, std::nullopt, labelFont);

    l11Btns.setupComponent(parent, l11.getSlider(), tabOrder, labelFont);
}
...
void GuiComponentSsgSwEnv11::layoutComponent(juce::Rectangle<int>& rect)
{
    ...
    l7Btns.setVisibles(visible && l7.isVisibleNudge());
    l8.setVisibleWithLabel(visible);
    l8Btns.setVisibles(visible && l8.isVisibleNudge());
    l9.setVisibleWithLabel(visible);
    l9Btns.setVisibles(visible && l9.isVisibleNudge());
    l10.setVisibleWithLabel(visible);
    l10Btns.setVisibles(visible && l10.isVisibleNudge());
    l11.setVisibleWithLabel(visible);
    l11Btns.setVisibles(visible && l11.isVisibleNudge());
    ...
    if (visible)
    {
        ...
        if (l7.isVisibleNudge()) l7Btns.layoutComponent(rect, 13);
        l8.layoutComponent(rect, 13);
        if (l8.isVisibleNudge()) l8Btns.layoutComponent(rect, 13);
        l9.layoutComponent(rect, 13);
        if (l9.isVisibleNudge()) l9Btns.layoutComponent(rect, 13);
        l10.layoutComponent(rect, 13);
        if (l10.isVisibleNudge()) l10Btns.layoutComponent(rect, 13);
        l11.layoutComponent(rect, 13);
        if (l11.isVisibleNudge()) l11Btns.layoutComponent(rect, 13);
...
void GuiComponentSsgSwEnv11::layoutComponentRow(juce::Rectangle<int>& rect)
{
    ...
    if (visible)
    {
        ...
        if (l7.isVisibleNudge()) l7Btns.layoutComponentRow(rect, 12);
        l8.layoutComponentRow(rect, 12);
        if (l8.isVisibleNudge()) l8Btns.layoutComponentRow(rect, 12);
        l9.layoutComponentRow(rect, 12);
        if (l9.isVisibleNudge()) l9Btns.layoutComponentRow(rect, 12);
        l10.layoutComponentRow(rect, 12);
        if (l10.isVisibleNudge()) l10Btns.layoutComponentRow(rect, 12);
        l11.layoutComponentRow(rect, 12);
        if (l11.isVisibleNudge()) l11Btns.layoutComponentRow(rect, 12);
...
void GuiComponentSsgSwEnv11::exportParams() {
    ...
    fileChooser = std::make_unique<juce::FileChooser>(Io::Dialog::Title::exportSsgSwEnvParamFile, defaultDir.getChildFile("default.ssgSwEnv11.json"), Io::ExtensionGlob::SsgSwEnvParam11);
...
void GuiComponentSsgSwEnv11::readParams(const Io::ParamReader& reader, const juce::String& prefix)
{
...
void GuiComponentSsgSwEnv11::writeParams(Io::ParamWriter& writer, const juce::String& prefix)
{
