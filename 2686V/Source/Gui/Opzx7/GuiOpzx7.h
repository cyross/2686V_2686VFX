...
class GuiOpzx7 : public GuiBase
{
    ...
    static inline const std::array<std::array<juce::String, Opzx7PrValue::ops>, Opzx7PrValue::algorithms> algOpPrefix = { {
        ...
        { {"([C:FB])", "([C])", "([C])", "([C])", "([C])", "([C])", "([C])", "(--)"} },                       // 113
        { {"([M:FB->2])", "([M->3])", "([M->4])", "([M->5])", "([M->6])", "[M->7]", "([C])", "(--)"} },       // 114
        { {"([C:FB])", "([C])", "([C])", "([C])", "([C])", "([C])", "([C])", "([C])"} },                      // 115
        { {"([M:FB->2])", "([M->3])", "([M->4])", "([M->5])", "([M->6])", "([M->7])", "([M->8])", "([C])"} }  // 116
    }};
    ...
    { { true, true, true, true, true, true, true, false } },   // 113
    { { true, true, true, true, true, true, true, false } },   // 114
    { { true, true, true, true, true, true, true, true } },    // 115
    { { true, true, true, true, true, true, true, true } }     // 116
} };
