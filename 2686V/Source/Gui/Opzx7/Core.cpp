...
void GuiOpzx7::setup()
{
    ...
    for (int i = 0; i < 4; ++i)
    {
        ...
        catSsgSwEnv[i].setup({ .parent = *this, .title = Opzx7GuiText::Category::visibleSwEnv, .invisibleTitle = Opzx7GuiText::Category::invisibleSwEnv, .enableChangeDetailVisible = true });
