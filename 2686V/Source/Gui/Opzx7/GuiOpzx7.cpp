...
static std::vector<SelectItem> opzx7AlgItems = {
    ...
    {.name = "36: <OPS-00>", .value = 37 },
    {.name = "37: <OPS-01>", .value = 38 },
    {.name = "38: <OPS-02>", .value = 39 },
    {.name = "39: <OPS-03>", .value = 40 },
    {.name = "40: <OPS-04>", .value = 41 },
    {.name = "41: <OPS-05>", .value = 42 },
    {.name = "42: <OPS-06>", .value = 43 },
    {.name = "43: <OPS-07>", .value = 44 },
    {.name = "44: <OPS-08>", .value = 45 },
    {.name = "45: <OPS-09>", .value = 46 },
    {.name = "46: <OPS-10>", .value = 47 },
    {.name = "47: <OPS-11>", .value = 48 },
    {.name = "48: <OPS-12>", .value = 49 },
    {.name = "49: <OPS-13>", .value = 50 },
    {.name = "50: <OPS-14>", .value = 51 },
    {.name = "51: <OPS-15>", .value = 52 },
    {.name = "52: <OPS-16>", .value = 53 },
    {.name = "53: <OPS-17>", .value = 54 },
    {.name = "54: <OPS-18>", .value = 55 },
    {.name = "55: <OPS-19>", .value = 56 },
    {.name = "56: <OPS-20>", .value = 57 },
    {.name = "57: <OPS-21>", .value = 58 },
    {.name = "58: <OPS-22>", .value = 59 },
    {.name = "59: <OPS-23>", .value = 60 },
    {.name = "60: <OPS-24>", .value = 61 },
    {.name = "61: <OPS-25>", .value = 62 },
    {.name = "62: <OPS-26>", .value = 63 },
    {.name = "63: <OPS-27>", .value = 64 },
    {.name = "64: <OPS-28>", .value = 65 },
...
void GuiOpzx7::setup()
{
    ...
    importSsgSwEnvParamButton.setup({ .parent = mainGroup.contentCanvas, .title = Opzx7GuiText::Utility::ssgSwEnvFileImport, .bgColor = juce::Colours::darkblue, .isReset = false, .isResized = false });
    ...
    importDetuneParamButton.setup({ .parent = mainGroup.contentCanvas, .title = Opzx7GuiText::Utility::detuneFileImport, .bgColor = juce::Colours::darkblue, .isReset = false, .isResized = false });
    ...
    importQualityParamButton.setup({ .parent = mainGroup.contentCanvas, .title = Opzx7GuiText::Utility::qualityFileImport, .bgColor = juce::Colours::darkgreen, .isReset = false, .isResized = false });
