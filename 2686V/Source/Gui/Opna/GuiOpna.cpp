...
void GuiOpna::setup()
{
    ...
    copyParamsToOpmBtn.setup({ .parent = mainGroup.contentCanvas, .title = "Params -> OPM" });
...
void GuiOpna::layout(juce::Rectangle<int> content)
{
    ...
    // 区切り線エリアを確保
    auto presetNameSeparatorArea = mmRect.removeFromTop(OpnaGuiValue::MainGroup::Separator::height);
