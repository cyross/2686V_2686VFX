...
namespace OpnaGuiText
{
	...
	namespace Category
	{
		...
		static inline const juce::String invisibleHwLfo = u8"[□]--- HW LFO ---";
	...
	namespace Group
	{
		static inline const juce::String mainGroup = juce::String("") + "OPNAチャンネル設定";
	...
	namespace Fm
	{
		...
		namespace Op
		{
			...
			static inline const juce::String SEnv = u8"Shape";
	...
	namespace Utility
	{
		...
		static inline const juce::String hwLfoFileImport = u8"Import LFO Param (.lfoOpna)";
		static inline const juce::String hwLfoFileExport = u8"Export LFO Param (.lfoOpna)";
