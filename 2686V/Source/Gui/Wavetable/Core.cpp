...
void GuiWt::setup()
{
    ...
    unisonCat.setupOtherCategory({ .parent = *this, .title = WtGuiText::Category::invisibleUnison, .invisibleTitle = WtGuiText::Category::invisibleUnison, .enableChangeDetailVisible = true });

    unisonVoicesSlider.setup({ .parent = *this, .id = code + WtPrKey::Unison::voices, .title = WtGuiText::Unison::voices, .isReset = true });
    unisonVoicesSlider.setWantsKeyboardFocus(true);
    unisonVoicesSlider.setExplicitFocusOrder(++tabOrder);

    unisonDetuneSlider.setup({ .parent = *this, .id = code + WtPrKey::Unison::detune, .title = WtGuiText::Unison::detune, .isReset = true });
    unisonDetuneSlider.setWantsKeyboardFocus(true);
    unisonDetuneSlider.setExplicitFocusOrder(++tabOrder);

    unisonSpreadSlider.setup({ .parent = *this, .id = code + WtPrKey::Unison::spread, .title = WtGuiText::Unison::spread, .isReset = true });
...
void GuiWt::layoutUnisonCat(juce::Rectangle<int>& rect) {
