...
void GuiOpn::setup()
{
    ...
    importLfoParamButton.setup({ .parent = mainGroup.contentCanvas, .title = OpnGuiText::Utility::lfoFileImport, .bgColor = juce::Colours::darkkhaki.darker(0.5f), .isReset = false, .isResized = false });
    ...
    importUnisonParamButton.setup({ .parent = mainGroup.contentCanvas, .title = OpnGuiText::Utility::unisonFileImport, .bgColor = juce::Colours::darkkhaki.darker(0.5f), .isReset = false, .isResized = false });
    ...
    importQualityParamButton.setup({ .parent = mainGroup.contentCanvas, .title = OpnGuiText::Utility::qualityFileImport, .bgColor = juce::Colours::darkkhaki.darker(0.5f), .isReset = false, .isResized = false });
    ...
    for (int i = 0; i < OpnPrValue::ops; ++i)
    {
        ...
        catAmp[i].setupHwCategory({ .parent = opGroups[i].contentCanvas, .title = OpnGuiText::Category::visibleAmpEnv, .invisibleTitle = OpnGuiText::Category::invisibleAmpEnv, .enableChangeDetailVisible = true });
