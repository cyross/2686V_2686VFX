...
namespace OpmGuiText
{
	...
	namespace Group
	{
		static inline const juce::String mainGroup = juce::String("") + "OPMチャンネル設定";
	...
	namespace Utility
	{
		...
		static inline const juce::String lfoFileImport = u8"Import LFO Param (.lfoOpm)";
		static inline const juce::String lfoFileExport = u8"Export LFO Param (.lfoOpm)";
