...
void GuiAbout::setup()
{
    ...
    pluginNameLabel.setFont(
        juce::Font(
            juce::FontOptions(
                AboutGuiValue::PluginName::fontFamily,
                AboutGuiValue::PluginName::fontSize,
    ...
    versionLabel.setFont(
        juce::Font(
            juce::FontOptions(
                AboutGuiValue::PluginVerion::fontSize
            )
        )
    );
    ...
    copyrightLabel.setFont(
        juce::Font(
            juce::FontOptions(
                AboutGuiValue::PluginCioyright::fontSize
            )
        )
    );
    ...
    vstGuidelineLabel.setFont(
        juce::Font(
            juce::FontOptions(
                AboutGuiValue::VstNotice::fontSize
            )
        )
    );
    ...
    gplNoticeLabel.setFont(
        juce::Font(
            juce::FontOptions(
                AboutGuiValue::GplNotice::fontSize
            )
        )
    );
    ...
    gplLinkButton.setFont(
        juce::Font(
            juce::FontOptions(
                AboutGuiValue::GplLink::fontSize
            )
