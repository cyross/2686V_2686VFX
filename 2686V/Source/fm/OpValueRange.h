...
static inline const int mOpl3AlgMin = 1; // 最小値
static inline const int mOpl3AlgMax = 8; // 最大値
static inline const int mOpl3AlgDefault = 1; // 初期値
...
static inline const int opWsMax = 28; // 最大値
...
static inline const int wtWaveformMax = 1; // 最大値
