...
void RhythmProcessor::createLayout(juce::AudioProcessorValueTreeState::ParameterLayout& layout)
{
    ...
    // Rhythm Parameters
    // ==========================================
    layout.add(std::make_unique<juce::AudioParameterFloat>(code + PrKey::Post::Rhythm::level, code + PrName::Rhythm::vol, PrValue::Rhythm::Vol::min, PrValue::Rhythm::Vol::max, PrValue::Rhythm::Vol::initial));
    ...
    for (int i = 0; i < PrValue::Rhythm::pads; ++i) {
        ...
        layout.add(std::make_unique<juce::AudioParameterFloat>(prefix + PrKey::Post::Rhythm::Pad::volume, namePrefix + PrName::Rhythm::Pad::Post::vol, PrValue::Rhythm::Pad::Vol::min, PrValue::Rhythm::Pad::Vol::max, PrValue::Rhythm::Pad::Vol::initial));
        layout.add(std::make_unique<juce::AudioParameterFloat>(prefix + PrKey::Post::Rhythm::Pad::pan, namePrefix + PrName::Rhythm::Pad::Post::pan, PrValue::Rhythm::Pad::Pan::min, PrValue::Rhythm::Pad::Pan::max, PrValue::Rhythm::Pad::Pan::initial));
        ...
        layout.add(std::make_unique<juce::AudioParameterInt>(prefix + PrKey::Post::Rhythm::Pad::mode, namePrefix + PrName::Rhythm::Pad::Post::bit, PrValue::Rhythm::Pad::Bit::min, PrValue::Rhythm::Pad::Bit::max, PrValue::Rhythm::Pad::Bit::initial));

        // 1: 96kHz 2: 55.5kHz 3: 48kHz 4: 44.1kHz 5: 22.5kHz 6: 16k 7: 8k
        layout.add(std::make_unique<juce::AudioParameterInt>(prefix + PrKey::Post::Rhythm::Pad::rate, namePrefix + PrName::Rhythm::Pad::Post::rate, PrValue::Rhythm::Pad::Rate::min, PrValue::Rhythm::Pad::Rate::max, PrValue::Rhythm::Pad::Rate::initial));
