...
void Opzx3Operator::setParameters(const Opzx3OpParams& params, float feedback)
{
    m_params = params;
    m_feedback = feedback;
...
// 6: +0.25%
// 7: +0.45%
const std::array<float, 8> Opzx3Operator::dtScales = { 0.0f, -0.0045f, -0.0025f, -0.001f, 0.0f, 0.001f, 0.0025f, 0.0045f };
...
// 2: x1.58 (780 cent up)
// 3: x1.78 (950 cent up)
const std::array<float, 4> Opzx3Operator::dt2Scales = { 1.0f, 1.414f, 1.581f, 1.781f };

const std::array<Opzx3Operator::SsgWaveCalculator, 16> Opzx3Operator::ssgWaveStrategies = { {
    [](double p) { // 00: normal
        return 1.0f;
    },
    [](double p) { // 01
...
void Opzx3Operator::updateEnvelopeState()
{
